...
import com.evoke.central.evokecentral.api.Client;
import com.evoke.central.evokecentral.api.Service;
...
public class Main2Activity extends BaseActivity {
            ...
            appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
                ...
                public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                    ...
                    if (scrollRange + verticalOffset == 0) {
                        collapsingToolbar.setTitle(getString(R.string.app_name2));
                        isShow = true;
                    } else if (isShow) {
                        collapsingToolbar.setTitle(" ");
                        isShow = false;
    ...
    private void initViews(){
        ...
        adapter = new ShowsAdapter(this, showList);
        ...
        try{
            ...
            call.enqueue(new Callback<ShowResponse>() {
                ...
                public void onResponse(Call<ShowResponse> call, Response<ShowResponse> response) {
                    ...
                    recyclerView.setAdapter(new ShowsAdapter(getApplicationContext(), items));
                    recyclerView.smoothScrollToPosition(0);
                    pd.hide();
                    Toast.makeText(Main2Activity.this, "Fetch completed...", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onFailure(Call<ShowResponse> call, Throwable t) {
                    Log.d("Error", t.getMessage());
                    Toast.makeText(Main2Activity.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
                    pd.hide();
