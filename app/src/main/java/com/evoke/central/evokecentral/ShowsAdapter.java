...
public class ShowsAdapter extends RecyclerView.Adapter<ShowsAdapter.MyViewHolder>{
    ...
    public ShowsAdapter(Context mContext, List<Show> showList) {
        this.mContext = mContext;
        this.showList = showList;
    }

    @Override
    public ShowsAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.show_card, viewGroup, false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ShowsAdapter.MyViewHolder viewHolder, int i) {


        viewHolder.title.setText(showList.get(i).getName());
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        ...
                        intent.putExtra("name", showList.get(pos).getName());
